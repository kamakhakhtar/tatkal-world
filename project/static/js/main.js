...
// Event handler for clicks outside of the modal
$(document).on('click', function (e) {
    if (modalOpen && !$(e.target).closest(".ps-login--modal").length) {
        closeModal();
    }
}); 
    }
    ...
    function slickCarousel() {
        if ($('.ps-product--gallery .ps-product__thumbnail').length) {
            // Initialize the main product image carousel
    ...
    // Call the slickCarousel function to initialize the carousel
